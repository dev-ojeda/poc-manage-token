...
class Config:
    ...
    REFRESH_TOKEN_EXP_DAYS = os.getenv('REFRESH_TOKEN_EXP_DAYS',"1")
    REFRESH_TOKEN_EXP_ADMIN = os.getenv('REFRESH_TOKEN_EXP_ADMIN',"1")
    ACCESS_TOKEN_EXP_MINUTES = os.getenv('ACCESS_TOKEN_EXP_MINUTES',"4")
    ACCESS_TOKEN_EXP_ADMIN = os.getenv('ACCESS_TOKEN_EXP_ADMIN',"60")
