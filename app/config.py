...
class Config:
    ...
    REFRESH_TOKEN_EXP_SECONDS = int(os.getenv('REFRESH_TOKEN_EXP_SECONDS',360))
    REFRESH_TOKEN_EXP_ADMIN = int(os.getenv('REFRESH_TOKEN_EXP_ADMIN',7200))
    ACCESS_TOKEN_EXP_SECONDS = int(os.getenv('ACCESS_TOKEN_EXP_SECONDS',180))
    ACCESS_TOKEN_EXP_ADMIN = int(os.getenv('ACCESS_TOKEN_EXP_ADMIN',3600))
    ACCESS_TOKEN_GLOBAL_EXP_SECONDS = int(os.getenv('ACCESS_TOKEN_GLOBAL_EXP_SECONDS',120))
